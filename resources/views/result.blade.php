...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Overall Results</h1>
                </div>
<br>
 <div class="row">
                <div class="col-lg-12">
                    ...
                    <tr>
                      ...
                      <td>{{ ($value->j1_performance + $value->j2_performance + $value->j3_performance) / 3 }}
                      </td>

                      <td>{{ ($value->j1_entertainment + $value->j2_entertainment + $value->j3_entertainment) / 3 }}
                      </td>

                      <td>{{ ($value->j1_costume + $value->j2_costume + $value->j3_costume) / 3 }}
                      </td>

                      <td>{{ ($value->j1_audience + $value->j2_audience + $value->j3_audience) / 3 }}
                      </td>

                      <td>{{($value->j1_performance + $value->j1_entertainment + $value->j1_costume + $value->j1_audience + $value->j2_performance + $value->j2_entertainment + $value->j2_costume + $value->j2_audience + $value->j3_performance + $value->j3_entertainment + $value->j3_costume + $value->j3_audience) / 3}}</td>
